...
from .servicebase import ListenerService, ServiceBase, ListenerServiceEvent, SelfserveClient
...
class TCListener(ListenerService):
    ...
    def __init__(self, pulse_queue_basename, pulse_exchange_basename, worker_type,
                 selfserve_url, allowed_builders=(), *args, **kwargs):
    ...
    def handleException(self, data, msg):
        ...
        if reason == "canceled":
            our_task = self.bbb_db.getTask(data["status"]["taskId"])
